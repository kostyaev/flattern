...
alter table account drop column if exists avatar_url;
alter table account drop column if exists auth_method;
...
alter table account add auth_method varchar(255);
...
drop index account_identity_id;